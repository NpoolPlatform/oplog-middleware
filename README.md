...
[![Test](https://github.com/NpoolPlatform/oplog-middleware/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/oplog-middleware/actions/workflows/main.yml)
...
* make oplog-middleware ```单独编译服务```
* make oplog-middleware-image ```单独生成服务镜像```
